...
Подробнее о ней смотрите в  [Specifications and types](../../advanced/typespec) уроке.

## ExDoc

ExDoc - это официальный проект Elixir, который находится на [GitHub](https://github.com/elixir-lang/ex_doc).
